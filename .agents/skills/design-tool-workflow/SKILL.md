...
Treat text supplied with the skill invocation as the tool set or workflow to
design. Keep the route bounded and verify structured results separately from
